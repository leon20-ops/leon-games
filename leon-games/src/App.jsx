...
function Navigation() {
  return (
    <motion.header 
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-[#050505]/80 backdrop-blur-md border-b border-white/[0.06] h-16 flex items-center justify-between px-6 lg:px-12"
    >
      <div className="flex items-center gap-2">
        {/* Leon Logo Symbol */}
        <div className="relative w-8 h-8 flex items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-400 p-[1.5px] shadow-[0_0_15px_rgba(34,197,94,0.2)]">
          <div className="bg-[#0A0A0A] w-full h-full rounded-[6px] flex items-center justify-center font-black text-sm text-white tracking-tighter">
            L
          </div>
        </div>
        <span className="font-bold text-lg tracking-wider bg-gradient-to-r from-white via-neutral-200 to-neutral-400 bg-clip-text text-transparent">
          LEON <span className="text-emerald-500 text-xs tracking-normal font-semibold px-1.5 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 ml-1">GAMES</span>
        </span>
      </div>
      ...
      <nav className="hidden md:flex items-center gap-8 text-sm text-neutral-400 font-medium">
        ...
        <a href="#worldwide" className="hover:text-white transition-colors">Global Network</a>
      </nav>

      <div className="flex items-center gap-4">
        <button className="text-sm text-neutral-300 font-semibold hover:text-white transition-colors">
          Log In
        </button>
        <button className="relative group overflow-hidden rounded-full bg-emerald-500 hover:bg-emerald-400 text-[#050505] font-semibold text-xs py-2.5 px-5 transition-all duration-300 shadow-[0_4px_20px_rgba(34,197,94,0.3)] hover:shadow-[0_4px_25px_rgba(34,197,94,0.5)]">
